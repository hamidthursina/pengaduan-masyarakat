                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" action="daftar_m.php">
                                           ...
                                           <br> <input type="submit" class="btn btn-primary btn-user btn-block" value="Daftar" href="login.php"></input>
                                            <hr></br>

                                        </form>
                                        <div class="text-center">
                                            <div class="small">Sudah Punya Akun ngab?
